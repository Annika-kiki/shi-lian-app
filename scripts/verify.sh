...
if APP_ENV=production MYSQL_ADDRESS=db:3306 MYSQL_USERNAME=shi_lian_migrator MYSQL_PASSWORD=test MYSQL_DATABASE=shi_lian_staging sh scripts/migrate_staging.sh >/dev/null 2>&1; then
